package app.movies.ui.presenter;
...
import app.movies.App;
import app.movies.network.MovieResponse;
import app.movies.network.RestClient;
import app.movies.ui.view.MoviesAdapter;
...
public class PopularPresenter {
    ...
    private final PopularFragment view;

    @Inject
    RestClient.TMDBService service;

    private final String TAG = PopularPresenter.class.getSimpleName();

    private int currentPage;
    private String queryText;

    public PopularPresenter(final PopularFragment view) {
