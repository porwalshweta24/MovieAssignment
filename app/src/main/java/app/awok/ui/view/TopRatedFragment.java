...
import app.awok.utils.RecyclerViewMargin;
...
public class TopRatedFragment extends Fragment {
    ...
    private TopRatedPresenter landingPresenter;
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        this.landingPresenter = new TopRatedPresenter(this);
...
//                = new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
    ...
    public TopRatedPresenter getLandingPresenter() {
